          ...
          >
            <ul className="pt-4 text-base text-gray-400 md:flex md:justify-between md:pt-0">
              ...
              <li>
                {user ? (
                  <Link
                    className="md:p-3 mt-1  py-3 pr-4 md:pl-3  md:hover:bg-transparent md:border md:dark:hover:bg-transparent font-serif focus:outline-none focus:ring-blue-300 md:hover:bg-opacity-10 rounded"
                    to="/dashboard"
                  >
                    Get started
                  </Link>
                  ...
                  <Link
                    className="bg-transparent text-[#BB254A] px-9 py-3   md:border border-[#BB254A]  font-serif rounded-full"
                    to="/login"
                  >
                    Login
                  </Link>
