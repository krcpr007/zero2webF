  ...
  return (
    <>
        <section className="">
          <div>
             ...
             <div className="text-[#EFD1C6] font-serif absolute lg:top-1/2 left-20">
              <h1 className="lg:text-6xl text-xl font-medium py-2">Boost Hardware <br /> When Needed</h1>
              <p className="py-3">Zero2 is empowering developers & animators <br /> to keep innovating for the next decade</p>
              <button className="bg-[#BB254A] rounded-full shadow-2xl px-9 py-3">Get Started</button>
             </div>
          </div>
        </section>
        <section className="bg-[#351228] text-[#EFD1C6]">
          ...
          <img className="w-[450px] mx-auto my-5" src={DragDrop} alt="" />
          ...
          <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
            ...
            <img className="w-[400px] mx-auto my-5" src={time} alt="no internet"/>
          </div>
          <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
            <img className="w-[400px] mx-auto my-5" src={together} alt="no internet"/>
            <div className="flex flex-col justify-center">
